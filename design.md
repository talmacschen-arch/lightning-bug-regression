...
### 18.M6 运行体验深化（done, v1.14 + post-M6 iter v1.15）

- **状态**：✅ DONE — 6 子步骤 + 1 dogfood + 4 parallel UI 小 PR + 5 PR post-sprint UX iteration
- **关键 §**：§13.12 M6 plan / §13.14 M6 retro (含 §13.14.8 post-M6 iter)
...
- **关键 PR (post-M6, v1.15)**：#119 Settings allowlist 砍 2 / #120 Skip List combobox / #121 RunsPage `?case_id=X` filter / #122 until_date label / #123 砍 Settings + 加 external/dut.yml (设计层重大决策)
